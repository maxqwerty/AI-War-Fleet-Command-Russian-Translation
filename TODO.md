...
- [x] Заменить "Снабжение", "Снабжать" (Supply) на "Поставлять/обеспечивать ресурсы". Проверить уже переведённые "обеспечить питанием" и заменить.
...
- [x] Заменить "Обладает" или "Владеет" на "Имеет"
...
- [ ] В описании кораблей тавталогия: "Снаряды: снаряд" (см. Космотанк на галактической карте). Заменить на "Вооружение" или типа того
- [ ] В описании "Прост. Скопления" и "Реал. Скопления" возможно получится написать полной формой без точки
- [ ] Пересмотреть описания на словах "ПРОСТОЙ" и "РЕАЛИСТИЧНЫЙ", возможно получится заменить
- [ ] Когда не хватает Науки, в Лаборатории пишет "ЗНАН". Нужно поменять на "НАУК"
- [ ] В описании новых технологий в Лаборатирии пишется "Требование:", а когда их нет - "---". Нужно подумать, как сделать красивее обе надписи.
- [ ] Перевести текст в значениях секции "Устан. скрипт"
- [ ] Заменить перевод "скрипт" на "сценарий"
- [ ] Подумать над переводом "У вас" и "У врагов" (в тултипе при наведении на панели кораблей справа)
- [X] Исправить "последующий взломА"
- [ ] Термин юнит/корабль местами смешивается без системы. Лучше перевести всё в "корабли".
- [ ] Заменить Piercing с "Игольчатый" на "Бронебойный"
